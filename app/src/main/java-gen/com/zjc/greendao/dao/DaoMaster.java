...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        DevprtlineDao.createTable(db, ifNotExists);
        DescDao.createTable(db, ifNotExists);
        HistoryDao.createTable(db, ifNotExists);
        NetaddressDao.createTable(db, ifNotExists);
        PlanDao.createTable(db, ifNotExists);
        TasksDao.createTable(db, ifNotExists);
        TasktabDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        DevprtlineDao.dropTable(db, ifExists);
        DescDao.dropTable(db, ifExists);
        HistoryDao.dropTable(db, ifExists);
        NetaddressDao.dropTable(db, ifExists);
        PlanDao.dropTable(db, ifExists);
        TasksDao.dropTable(db, ifExists);
        TasktabDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(DevprtlineDao.class);
        registerDaoClass(DescDao.class);
        ...
        registerDaoClass(TasktabDao.class);
    }
